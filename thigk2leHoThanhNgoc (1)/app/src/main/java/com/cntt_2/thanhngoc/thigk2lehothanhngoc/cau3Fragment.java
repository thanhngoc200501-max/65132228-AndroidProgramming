...
public class cau3Fragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        list.add(new LandScape("Hà Nội", "thac"));
        list.add(new LandScape("Quảng Ninh", "quangninh"));
        list.add(new LandScape("Đà Nẵng", "hoian"));
        list.add(new LandScape("Hà Giang", "img_1.png"));
        list.add(new LandScape("Cao Bằng", "img.png"));
        list.add(new LandScape("Khánh Hòa", "vhlong"));
